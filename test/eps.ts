    ...
    "_children": [
        ...
        },
        {
            ...
            _children: [
                ...
                {
                    "_type": "path",
                    // d: 'M0,0 L0,100 C12.813304,69.060446 29.153174,50 50,50 C70.846826,50 87.513493,69.387243 100,100 L100,0 L0,0 Z',
...
fs.writeFileSync('out/ui.eps', toEps(root), 'utf8')
